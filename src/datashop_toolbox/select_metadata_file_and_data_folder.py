...
from PyQt6.QtWidgets import (
    QApplication, QMainWindow, QHBoxLayout, QVBoxLayout, QPushButton, QFileDialog, QLabel, QLineEdit, QWidget, QDialogButtonBox
)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        h_layout1.addWidget(self.file_button)
        h_layout1.addWidget(self.folder_button)

        # Horizontal layout for buttons used to close the window
        h_layout2 = QHBoxLayout()
        h_layout2.addStretch(1)
        h_layout2.addWidget(self.buttonBox)
        h_layout2.addStretch(1)
