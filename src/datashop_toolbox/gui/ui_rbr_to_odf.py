...
class Ui_main_window:
    def setupUi(self, main_window):
        ...
        self.rsk_list_label.setObjectName("rsk_list_label")
        font1 = QFont()
        ...
        self.rsk_list_widget.setObjectName("rsk_list_widget")
        font2 = QFont()
        ...
        self.channel_list_label.setObjectName("channel_list_label")
        ...
        self.latitude_line_edit.setObjectName("latitude_line_edit")
        ...
        self.longitude_line_edit.setObjectName("longitude_line_edit")
        ...
        self.profile_plots_push_button.setObjectName("profile_plots_push_button")
        font4 = QFont()
        ...
        self.clear_info_push_button.setObjectName("clear_info_push_button")
        ...
        self.edit_metadata_push_button.setObjectName("edit_metadata_push_button")
        ...
        self.export_odf_push_button.setObjectName("export_odf_push_button")
        ...
        self.export_btl_push_button.setObjectName("export_btl_push_button")
        ...
        self.odf_folder_line_edit.setObjectName("odf_folder_line_edit")
        ...
        self.grid_layout.addWidget(self.exit_push_button, 1, 0, 1, 1, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignVCenter)  # noqa: E501
        ...
        self.select_folder_push_button.setObjectName("select_folder_push_button")
    ...
    def retranslateUi(self, main_window):
        main_window.setWindowTitle(QCoreApplication.translate("main_window", "RSK to ODF Conversion Application", None))
        self.title_label.setText(QCoreApplication.translate("main_window", "Conversion of RBR Ruskin (.rsk) file(s) to ODF file(s)", None))  # noqa: E501
        self.rsk_list_label.setText(QCoreApplication.translate("main_window", "RSK Files Found in Selected Folder", None))  # noqa: E501
        self.channel_list_label.setText(QCoreApplication.translate("main_window", "Channels found in loaded RSK File", None))  # noqa: E501
        self.latitude_label.setText(QCoreApplication.translate("main_window", "Station Latitude:", None))
        self.longitude_label.setText(QCoreApplication.translate("main_window", "Station Longitude:", None))
        self.profile_plots_push_button.setText(QCoreApplication.translate("main_window", "DISPLAY PROFILES FOR SELECTED FILE", None))  # noqa: E501
        self.clear_info_push_button.setText(QCoreApplication.translate("main_window", "CLEAR IMPORTED RSK INFO", None))
        self.edit_metadata_push_button.setText(QCoreApplication.translate("main_window", "EDIT ODF METADATA", None))
        self.export_odf_push_button.setText(QCoreApplication.translate("main_window", "EXPORT TO ODF", None))
        self.export_btl_push_button.setText(QCoreApplication.translate("main_window", "EXPORT TO BTL", None))
        self.odf_folder_line_edit.setText(QCoreApplication.translate("main_window", "Full folder path to where .odf file will be exported ...", None))  # noqa: E501
        self.exit_push_button.setText(QCoreApplication.translate("main_window", "EXIT", None))
        self.select_folder_push_button.setText(QCoreApplication.translate("main_window", "Select Folder with .RSK files", None))  # noqa: E501
        self.folder_line_edit.setText(QCoreApplication.translate("main_window", "Full folder path to .rsk files to be converted ...", None))  # noqa: E501
    # retranslateUi
