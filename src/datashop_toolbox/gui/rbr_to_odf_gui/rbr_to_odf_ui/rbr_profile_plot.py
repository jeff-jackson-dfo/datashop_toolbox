...
from ui_rsk_plot_dialog import Ui_PlotDialog
...
class PlotDialog(QDialog):
    ...
    def __init__(self, fig_handles: Optional[List] = None, parent=None, title: str = "RSK Profiles"):
        ...
        parent_layout.removeWidget(self.ui.profileGraphicsView)
        self.ui.profileGraphicsView.deleteLater()
        ...
        self._prev_action: Optional[QAction] = None
        self._next_action: Optional[QAction] = None

        # Wire footer buttons
        self.ui.buttonBox.accepted.connect(self.on_accept)
        self.ui.buttonBox.rejected.connect(self.on_reject)
        self.ui.saveProfileCheckBox.stateChanged.connect(self.on_save_checkbox_changed)
    ...
    def display_current_profile(self):
        ...
        self.ui.saveProfileCheckBox.setChecked(self.current_profile_index in self.saved_profiles)
        total = len(self.fig_handles)
