...
class Ui_thermograph_main_window:
    def setupUi(self, thermograph_main_window):
        if not thermograph_main_window.objectName():
            thermograph_main_window.setObjectName("thermograph_main_window")
        ...
        self.name_vertical_layout.setObjectName("name_vertical_layout")
        ...
        self.combos_horizontal_layout.setObjectName("combos_horizontal_layout")
        self.institution_vertical_layout = QVBoxLayout()
        self.institution_vertical_layout.setObjectName("institution_vertical_layout")
        self.institution_label = QLabel(self.centralwidget)
        self.institution_label.setObjectName("institution_label")
        ...
        self.institution_combo_box.addItem("")
        self.institution_combo_box.addItem("")
        self.institution_combo_box.setObjectName("institution_combo_box")
        ...
        self.instrument_vertical_layout.setObjectName("instrument_vertical_layout")
        ...
        self.instrument_combo_box.addItem("")
        self.instrument_combo_box.addItem("")
        self.instrument_combo_box.setObjectName("instrument_combo_box")
        ...
        self.metadata_push_button.setObjectName("metadata_push_button")
        ...
        self.data_folder_push_button.setObjectName("data_folder_push_button")
        ...
        self.metadata_horizontal_layout.setObjectName("metadata_horizontal_layout")
        ...
        self.data_folder_horizontal_layout.setObjectName("data_folder_horizontal_layout")
        self.data_folder_label = QLabel(self.centralwidget)
        self.data_folder_label.setObjectName("data_folder_label")
        ...
        self.data_folder_line_edit.setObjectName("data_folder_line_edit")
        ...
        self.ok_cancel_horizontal_layout.setObjectName("ok_cancel_horizontal_layout")
    ...
    def retranslateUi(self, thermograph_main_window):
        thermograph_main_window.setWindowTitle(QCoreApplication.translate("thermograph_main_window", "Choose Moored Thermograph Files to Process", None))  # noqa: E501
        self.name_label.setText(QCoreApplication.translate("thermograph_main_window", "Please enter the data processor's name in the text box below:", None))  # noqa: E501
        self.institution_label.setText(QCoreApplication.translate("thermograph_main_window", "Select institution:", None))  # noqa: E501
        self.institution_combo_box.setItemText(0, QCoreApplication.translate("thermograph_main_window", "Unknown", None))  # noqa: E501
        self.institution_combo_box.setItemText(1, QCoreApplication.translate("thermograph_main_window", "BIO", None))
        self.institution_combo_box.setItemText(2, QCoreApplication.translate("thermograph_main_window", "FSRS", None))

        self.instrument_label.setText(QCoreApplication.translate("thermograph_main_window", "Select instrument:", None))
        self.instrument_combo_box.setItemText(0, QCoreApplication.translate("thermograph_main_window", "Unknown", None))
        self.instrument_combo_box.setItemText(1, QCoreApplication.translate("thermograph_main_window", "Minilog", None))
        self.instrument_combo_box.setItemText(2, QCoreApplication.translate("thermograph_main_window", "Hobo", None))

        self.metadata_push_button.setText(QCoreApplication.translate("thermograph_main_window", "Select the Metadata file\n"  # noqa: E501
"(e.g. LFA .txt or Excel file)", None))
        self.data_folder_push_button.setText(QCoreApplication.translate("thermograph_main_window", "Select the Data folder\n"  # noqa: E501
"(Location of *.csv files)", None))
        self.metadata_label.setText(QCoreApplication.translate("thermograph_main_window", "Metadata file selected:", None))  # noqa: E501
        self.data_folder_label.setText(QCoreApplication.translate("thermograph_main_window", "Data folder selected:", None))  # noqa: E501
    # retranslateUi
