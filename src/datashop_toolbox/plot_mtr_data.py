...
my_path = 'C:/DFO-MPO/DEV/MTR/999_Test/'
my_file = 'MTR_BCD2014999_002_1273003_600.ODF'
full_path = str(pathlib.Path(my_path, my_file))
...
mtr.write_odf(my_path + 'Step_1_Create_ODF/' + qfs_out_file, version = 2.0)
