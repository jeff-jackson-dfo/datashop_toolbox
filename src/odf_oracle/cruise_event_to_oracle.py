...
def cruise_event_to_oracle(odfobj: OdfHeader, connection, infile: str) -> str:
    ...
    country_institute_code = str(odfobj.cruise_header.country_institute_code)
    ...
    with connection.cursor() as cursor:
        ...
        cursor.execute(
            ...
            ":dob, :stn, :setnum, :resprg, :dflag, :fname)",
            {
                ...
                "sdate": sytm_to_timestamp(odfobj.cruise_header.start_date, "date"),
                "edate": sytm_to_timestamp(odfobj.cruise_header.end_date, "date"),
                ...
                "cdate": sytm_to_timestamp(odfobj.event_header.creation_date, "datetime"),
                "odate": sytm_to_timestamp(odfobj.event_header.orig_creation_date, "datetime"),
                "sdt": sytm_to_timestamp(odfobj.event_header.start_date_time, "datetime"),
                "edt": sytm_to_timestamp(odfobj.event_header.end_date_time, "datetime"),
                "ilat": fix_null(float(odfobj.event_header.initial_latitude)),
                "ilon": fix_null(float(odfobj.event_header.initial_longitude)),
                ...
                "sint": fix_null(float(odfobj.event_header.sampling_interval)),
