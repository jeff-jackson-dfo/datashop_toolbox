...
for file_name in files:
    ...
    odf.add_to_log(
        'The primary conductivity [3561] calibration coefficient "Offset" was changed from its original '
        "value [0.0] to [-0.00066] for sensor pair 1."
    )
    odf.add_to_log(
        'The primary conductivity [3561] calibration coefficient "Slope" was changed from its original '
        "value [1.0] to [1.000039] for sensor pair 1."
    )
    odf.add_to_log(
        'The primary conductivity [1874] calibration coefficient "Offset" remained unchanged from its '
        "original value [0.0] to [0.00048] for sensor pair 2."
    )
    odf.add_to_log(
        'The primary conductivity [1874] calibration coefficient "Slope" remained unchanged from its '
        "original value [1.0] to [1.000016] for sensor pair 2."
    )
    odf.add_to_log(
        'The secondary conductivity [3562] calibration coefficient "Offset" was changed from its '
        "original value [0.0] to [-0.00132]."
    )
    odf.add_to_log(
        'The secondary conductivity [3562] calibration coefficient "Slope" was changed from its '
    ...
    odf.add_to_log(
        'The primary oxygen [0133] calibration coefficient "Soc" was changed from its original value '
        "of [0.3903] to [0.4054]."
    )
    odf.add_to_log(
        'The secondary oxygen [1588] calibration coefficient "Soc" was changed from its original value '
        "of [0.5347] to [0.4523]."
    )
